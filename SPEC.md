...
-   **Algorithm Type:** lossy (projection + quantization)

**Notes:**

-   Part of the file is human readable (UTF8/ASCII) to ease debugging but most data are in binary for space optimization and recent browsers can handle it with the JavaScript [ArrayBuffer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer "JavaScript ArrayBuffer").
...
<table>
    ...
    <tbody>
        <tr>
            <td rowspan="2">Segment Type</td>
            <td>Segment with elevation</td>
            <td rowspan="2">1 ASCII byte</td>
            <td>E</td>
        </tr>
        <tr>
            <td>Segment without elevation</td>
            <td>F</td>
        </tr>
        <tr>
...
Overall information about the segments (all combined):
